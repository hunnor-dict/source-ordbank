CREATE TABLE BM_BOYING_GRUPPER (
  BOY_GRUPPE VARCHAR(20) NOT NULL
);

CREATE TABLE BM_BOYING (
...
CREATE TABLE BM_PARADIGME_BOYING (
  PARADIGME_ID VARCHAR(5) NOT NULL,
  BOY_NUMMER INT(2) NOT NULL,
  BOY_GRUPPE VARCHAR(20) NOT NULL,
...
CREATE TABLE BM_FULLFORMSLISTE (
  LEMMA_ID INT(8) NOT NULL,
